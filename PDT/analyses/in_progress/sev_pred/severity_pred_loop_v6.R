...
# TODOs =======================================================================
warning('report: use plot roc curve function')
warning('current status: no non.linear model; no Takeuchi model')
warning('especially important for applying PDT behav to MRI behav')
warning('VPPG0233 POSTPILOT; VPPG08106 MRT is the same person; 1 year and 3 months apart;')
warning('Implement the entropy selections!')

# WHAT TO RUN =================================================================
outer_cv_noaddfeat_noperm = 0 # only behavior
outer_cv_noaddfeat_wiperm = 0 # only behavior [legacy! have not used in long time!]
noout_cv_noaddfeat_noperm = 0 # only behavior

outer_cv_wiaddfeat_noperm = 0 # adding physio
outer_cv_wiaddfeat_wiperm = 0 # adding physio [legacy! have not used in long time!]
noout_cv_wiaddfeat_noperm = 0 # adding physio

outer_cv_addfeaton_noperm = 0 # only physio
outer_cv_addfeaton_wiperm = 0 # only physio   [legacy! have not used in long time!]
noout_cv_addfeaton_noperm = 0 # only physio

outer_cv_c_model_noperm   = 0 # control model (alternative to permutation) for 1006 just one more time to 1005
...
# path
setwd(paste0(base_lib,'Library/R/PDT/analyses/in_progress/sev_pred'))
